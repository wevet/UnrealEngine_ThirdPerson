...
void FAnimNode_HumanoidFootRotationController::EvaluateSkeletalControl_AnyThread(
	...
	TArray<FBoneTransform>& OutBoneTransforms)
{
	...
	LastRotationOffset = bInterpolateRotation ?
		FQuat::Slerp(LastRotationOffset, TargetOffset, FMath::Clamp(RotationSlerpSpeed * DeltaTime, 0.0f, 1.0f)) :
		TargetOffset;
